...
class ArmsWorkoutScreen extends StatefulWidget {
  ...
  // Lista estática de exercícios para o treino de braço
  static final List<Map<String, dynamic>> exercises = [
    {
      'name': 'Rosca Direta 21 Barra W',
      'sets': '4x10',
      'weight': '0',
      'type': 'strength'
    },
    {
      'name': 'Rosca Alternada Banco Inclinado',
      'sets': '4x10',
      'weight': '0',
      'type': 'strength'
    },
    {
      'name': 'Rosca Concentrada Polia Baixa',
      'sets': '4x10',
      'weight': '0',
      'type': 'strength'
    },
    ...
    {
      'name': 'Triceps Testa Banco Inclinado Barra W',
      'sets': '4x10',
      'weight': '0',
      'type': 'strength'
    },
    {
      'name': 'Triceps Invertipo Polia Barra Reta',
      'sets': '4x10',
      'weight': '0',
      'type': 'strength'
    },
    ...
    {
      'name': 'Abdominal Oblíquo Alternado',
      'sets': '4x20',
      'weight': '0',
      'type': 'strength'
    },
                        ...
                        children: [
                          ...
                          Expanded(
                            child: ListView.builder(
                              itemCount: ArmsWorkoutScreen.exercises.length +
                                  1, // +1 para o espaço final
                              itemBuilder: (context, index) {
                                // Adiciona um espaço no final da lista
                                if (index ==
                                    ArmsWorkoutScreen.exercises.length) {
                                  return const SizedBox(height: 20);
                                }

                                final exercise =
                                    ArmsWorkoutScreen.exercises[index];
