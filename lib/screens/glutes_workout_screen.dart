...
class GlutesWorkoutScreen extends StatefulWidget {
  const GlutesWorkoutScreen({super.key});

  // Lista estática de exercícios para o treino de glúteos
  static final List<Map<String, dynamic>> exercises = [
    {
      'name': 'Abdução de Quadril na Polia Baixa Unilateral',
      'sets': '4x10',
      'weight': '0',
      'type': 'strength'
    },
    {
      'name': 'Gluteos Coice na Polia',
      'sets': '4x10',
      'weight': '0',
      'type': 'strength'
    },
    ...
    {'name': 'Mesa Flexora', 'sets': '4x10', 'weight': '0', 'type': 'strength'},
    {
      'name': 'Stiff Pés Afastados com Barra Livre',
      'sets': '4x10',
      'weight': '0',
      'type': 'strength'
    },
    ...
    {
      'name': 'Abdominal Supra no solo com Pés Altos',
      'sets': '4x20',
      'weight': '0',
      'type': 'strength'
    },
  ...
  @override
  State<GlutesWorkoutScreen> createState() => _GlutesWorkoutScreenState();
}

class _GlutesWorkoutScreenState extends State<GlutesWorkoutScreen>
                        ...
                        children: [
                          ...
                          Expanded(
                            child: ListView.builder(
                              itemCount: GlutesWorkoutScreen.exercises.length +
                                  1, // +1 para o espaço final
                              itemBuilder: (context, index) {
                                // Adiciona um espaço no final da lista
                                if (index ==
                                    GlutesWorkoutScreen.exercises.length) {
                                  return const SizedBox(height: 20);
                                }

                                final exercise =
                                    GlutesWorkoutScreen.exercises[index];
