...
class LegsWorkoutScreen extends StatefulWidget {
  const LegsWorkoutScreen({super.key});

  // Lista estática de exercícios para o treino de pernas
  static final List<Map<String, dynamic>> exercises = [
    ...
    {'name': 'Leg Press 45', 'sets': '4x10', 'weight': '0', 'type': 'strength'},
    {
  ...
  @override
  State<LegsWorkoutScreen> createState() => _LegsWorkoutScreenState();
}

class _LegsWorkoutScreenState extends State<LegsWorkoutScreen>
                        ...
                        children: [
                          ...
                          Expanded(
                            child: ListView.builder(
                              itemCount: LegsWorkoutScreen.exercises.length +
                                  1, // +1 para o espaço final
                              itemBuilder: (context, index) {
                                // Adiciona um espaço no final da lista
                                if (index ==
                                    LegsWorkoutScreen.exercises.length) {
                                  return const SizedBox(height: 20);
                                }

                                final exercise =
                                    LegsWorkoutScreen.exercises[index];
