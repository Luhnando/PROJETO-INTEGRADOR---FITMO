...
class BackWorkoutScreen extends StatefulWidget {
  ...
  // Lista estática de exercícios para o treino de costas
  static final List<Map<String, dynamic>> exercises = [
    ...
    {
      'name': 'Barra Fixa Graviton Pegada Aberta',
      'sets': '4x10',
      'weight': '0',
      'type': 'strength'
    },
    ...
    {
      'name': 'Remada Baixa Barra H',
      'sets': '4x10',
      'weight': '0',
      'type': 'strength'
    },
    {
      'name': 'Pulldown Barra Reta',
      'sets': '4x10',
      'weight': '0',
      'type': 'strength'
    },
    {
      'name': 'Abdominal Supra com Corda na Polia',
      'sets': '4x20',
      'weight': '0',
      'type': 'strength'
    },
    {'name': 'Cardio: Elíptico', 'time': '20', 'unit': 'min', 'type': 'cardio'},
  ];
                        ...
                        children: [
                          ...
                          Expanded(
                            child: ListView.builder(
                              itemCount: BackWorkoutScreen.exercises.length +
                                  1, // +1 para o espaço final
                              itemBuilder: (context, index) {
                                // Adiciona um espaço no final da lista
                                if (index ==
                                    BackWorkoutScreen.exercises.length) {
                                  return const SizedBox(height: 20);
                                }

                                final exercise =
                                    BackWorkoutScreen.exercises[index];
