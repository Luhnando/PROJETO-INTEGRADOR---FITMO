...
class ChestWorkoutScreen extends StatefulWidget {
  ...
  // Lista estática de exercícios para o treino de peito
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      SizedBox(
                          width: appBarPadding *
                              0.3), // Adiciona um pequeno espaço entre o botão e o texto
                      Padding(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: ListView.builder(
                              itemCount: ChestWorkoutScreen.exercises.length +
                                  1, // +1 para o espaço final
                              itemBuilder: (context, index) {
                                // Adiciona um espaço no final da lista
                                if (index ==
                                    ChestWorkoutScreen.exercises.length) {
                                  return const SizedBox(height: 20);
                                }

                                final exercise =
                                    ChestWorkoutScreen.exercises[index];
